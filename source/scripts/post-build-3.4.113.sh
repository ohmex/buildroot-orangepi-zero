...
#uboot_src_bin=$current/output/images/u-boot-sunxi-with-spl.bin
uboot_src_bin=$current/output/images/u-boot.bin
uboot_target_bin=$spibin/u-boot-mizi.bin
...
cp $uboot_src_bin $uboot_target_bin
